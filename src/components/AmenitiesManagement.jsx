   ...
   useEffect(()=>{
    ...
    return (
        <div className='w-full h-screen bg-zinc-200'>
            <h2 className="text-3xl text-blue-950 text-center font-bold mb-8 pt-8">AMENITIES MANAGEMENT</h2>
            <Link to="/AddNewAmenity"><button className='py-1 px-3  bg-red-950  rounded-md text-white ml-9 mb-6' >Add New Amenities</button></Link>
