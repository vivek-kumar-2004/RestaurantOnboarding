         ...
         <div className='w-4/5 h-Screen p-10 flex  justify-center  gap-10 translate-x-[23%] translate-y-[70%] '>
          ...
          <div className='content w-[30vw] flex flex-col pt-10'>
              ...
              <div className='flex gap-3'>
                <Link to={`/editMenuItem/${product._id}`} className='py-1 px-3 font-bold text-white bg-blue-900 rounded-md shadow-2xl  hover:scale-105'>Edit</Link>
                <button onClick={()=>handleProductDelete(product._id)} className='py-1 px-3 font-bold text-white bg-red-800 rounded-md shadow-2xl  hover:scale-105' >Delete</button>
              </div>
          </div>
        </div>
     </div>
